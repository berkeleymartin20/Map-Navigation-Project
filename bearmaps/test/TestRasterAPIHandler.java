...
public class TestRasterAPIHandler {
    ...
    public void testGradeScope() {
        ...
        params.put("ullon", -122.2665144573369);
        params.put("lrlon",-122.2484400275767);
        params.put("ullat",37.879535576369754);
        params.put("lrlat",37.82294299671161);
        params.put("w",559.896045188462);
        params.put("h",429.9475811910515);
        rasterer = new RasterAPIHandler();
        Map<String, Object> actual = rasterer.processRequest(params, null);
        System.out.println("supposed to be: 37.82280243352756");
        System.out.println("and got: " + actual.get("raster_lr_lat"));
    }
